...
public class PuTTYKeyFile extends BaseFileKeyProvider {
    ...
    protected KeyPair readKeyPair() throws IOException {
        ...
        final ECKeySpecFactory.CurveName ecdsaCurve;
        switch (keyType) {
            case ECDSA256:
                ecdsaCurve = ECKeySpecFactory.CurveName.SECP256R1;
                break;
            case ECDSA384:
                ecdsaCurve = ECKeySpecFactory.CurveName.SECP384R1;
                break;
            case ECDSA521:
                ecdsaCurve = ECKeySpecFactory.CurveName.SECP521R1;
                break;
            default:
                ecdsaCurve = null;
                break;
        ...
        if (ecdsaCurve != null) {
            ...
            try {
                final ECPrivateKeySpec privateKeySpec = ECKeySpecFactory.getPrivateKeySpec(s, ecdsaCurve);

                final PrivateKey privateKey = SecurityUtils.getKeyFactory(KeyAlgorithm.ECDSA).generatePrivate(privateKeySpec);
